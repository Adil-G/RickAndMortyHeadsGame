...
def test():
    ...
    json_handler.save_to_json(data,".\AI Test.json")

if __name__ == '__main__':
    
    test_data_json = json_handler.load_json(".\TestData.json")
    training_data_json = json_handler.load_json(".\TrainingData.json")
