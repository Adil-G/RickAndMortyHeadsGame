...
if __name__ == '__main__':
    ...
    test_data = json_handler.load_json(".\TestData.json")
    training_data = json_handler.load_json(".\TrainingData.json")
    ...
    for file_name in os.listdir('C:\Users\Tobe\Documents\Programming\Python\Python2\Music Analysis\Music'):
        ...
        if i%50 == 0:
            ...
            json_handler.save_to_json(test_data,".\TestData.json")
            json_handler.save_to_json(training_data,".\TrainingData.json")
